...
section). The caption accompanies the attached photos/videos of that part.
...
- Short, airy paragraphs separated by blank lines; emojis welcome but not
  overloaded.
- Tell a small story or share a feeling that matches the media; end with a
  question or "save this" style nudge, and you may reference "link in bio"
  for the full story.
